!(function(e, t) {
  ...
  function Ye(e) {
    return 0 === ke(e) && 0 === je(e) && 0 === Pe(e) && 0 === Ne(e)
  }
  function Ke(e, t, n) {
  ...
  var Ei = no(Ze, 'DataView'),
    ...
    Ni = Gr(Di),
    Pi = st
  ;((Ei && '[object DataView]' != Pi(new Ei(new ArrayBuffer(1)))) ||
    (ro && '[object Map]' != Pi(new ro())) ||
    (_i && '[object Promise]' != Pi(_i.resolve())) ||
    (Si && '[object Set]' != Pi(new Si())) ||
    (Di && '[object WeakMap]' != Pi(new Di()))) &&
    (Pi = function(e) {
      var t = st(e),
