!(function(e, t) {
  ...
  function Ye(e) {
    return 0 === ke(e) && 0 === je(e) && 0 === Ne(e) && 0 === Pe(e)
  }
  function Ke(e, t, n) {
      ...
      return (
        ...
        (t.prototype.render = function() {
          ...
          var D = m.title(o),
            ...
            T = m.start(o),
            x = m.allDay(o),
            P = c || x || Ke(T, Ue(O, 'day'), 'day') > 1,
            N = v.eventProp(o, T, O, i),
            j = r.createElement(
              'div',
          ...
          return r.createElement(
            ...
            r.createElement(
              ...
              a({}, S, {
                tabIndex: 0,
                style: a({}, N.style, t),
                className: G('rbc-event', n, N.className, {
                  'rbc-selected': i,
                  'rbc-event-allday': P,
  ...
  function Rn(e) {
    ...
    var o = {
      ...
      i = 'HTML' === e.nodeName ? Pn(e.ownerDocument) : {},
  ...
  ;((Ei && '[object DataView]' != Ni(new Ei(new ArrayBuffer(1)))) ||
    (ro && '[object Map]' != Ni(new ro())) ||
    (_i && '[object Promise]' != Ni(_i.resolve())) ||
    (Si && '[object Set]' != Ni(new Si())) ||
    (Di && '[object WeakMap]' != Ni(new Di()))) &&
    (Ni = function(e) {
      var t = st(e),
          ...
          return Aa(function(t) {
            for (
              var n = t.range,
                ...
                d = _a(p, c ? Math.max(o - 1, 1) : void 0),
                h = d.levels,
                m = d.extra;
              h.length < i;
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            r.createElement(
              ...
              a({ isAllDay: S }, P),
              O.map(function(e, t) {
                return r.createElement(Wr, a({ key: t, segments: e }, P))
              }),
              !!T.length &&
                r.createElement(
                  ka,
                  a({ segments: T, onShowMore: this.handleShowMore }, P)
                )
            )
          )
        )
  ...
  ;(La.propTypes = {}),
    (La.defaultProps = { minRows: 0, maxRows: 1 / 0, truncateEvents: !0 })
  var Ia = function(e) {
    var t = e.label
      ...
      return (
        ...
        (o.render = function() {
          var e = this.props,
            ...
            o = e.className,
            i = (function(e, t, n) {
              t = (n ? wt(e, t, n) : void 0 === t) ? 1 : Rt(Ct(t), 0)
              var r = null == e ? 0 : e.length
              if (!r || t < 1) return []
  ...
  var ms = (function(e) {
    ...
    return (
      ...
      (t.prototype.render = function() {
        ...
        return r.createElement(
          'div',
          a({ className: 'rbc-timeslot-group' }, p),
          o.map(function(e, o) {
            var i = s ? s.slotProp(e, n) : {},
              c = f ? 'gutter-' + i.className : i.className
            return r.createElement(
              u,
              { key: o, value: e, resource: n },
              r.createElement(
                'div',
                a({}, i, { className: G('rbc-time-slot', c) }),
                t && t(e, o)
              )
            )
          })
            ...
            r.on('selecting', o),
              ...
              r.on('beforeSelect', function(e) {
                if ('ignoreEvents' === t.props.selectable)
                  return !Nr(n.findDOMNode(re(t)), e)
              }),
              r.on('click', function(e) {
                return s(e, 'click')
              }),
  ...
  ;(xs.propTypes = {}),
    ...
    (xs.title = function(e, t) {
      var n = t.localizer,
        r = t.inclusiveRange,
        o = xs.range(e, { localizer: n, inclusiveRange: r }),
        i = o[0],
        a = o.slice(1)
      return n.format({ start: i, end: a.pop() }, 'dayRangeHeaderFormat')
    })
  var Ns,
    js = (function(e) {
      function t() {
  ...
  ;(js.propTypes = {}),
    (js.defaultProps = Os.defaultProps),
    (js.range = Ps),
    (js.navigate = xs.navigate),
    ...
    return (
      ...
      (n.render = function() {
        ...
        var g = this.getView(),
          ...
          S = y.viewNames,
          D = w.toolbar || Fs,
          M = g.title(u, { localizer: _, length: p, inclusiveRange: d })
        return r.createElement(
          'div',
          a({}, l, {
            className: G(c, 'rbc-calendar', v.rtl && 'rbc-rtl'),
            style: i,
          }),
          n &&
            r.createElement(D, {
