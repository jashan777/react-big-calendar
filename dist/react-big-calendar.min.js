  ...
  var ji = (function(e) {
    ...
    return (
      ...
      (s.componentDidUpdate = function(e, t) {
        var n = !z.eq(e.getNow(), this.props.getNow(), 'minutes')
        if (
          ...
          var r =
            !n &&
            z.eq(e.date, this.props.date, 'minutes') &&
  ...
  ;(Fi.propTypes = {}),
    ...
    (Fi.range = function(e, t) {
      var n = t.localizer,
        r = t.inclusiveRange,
        o = n.startOfWeek(),
        a = z.startOf(e, 'week', o),
        i = z.endOf(e, 'week', o)
      return r.map(function(e) {
        return z.range(a, i).find(function(t) {
          return t.getDay() == e
        })
      })
    }),
    (Fi.title = function(e, t) {
      var n = t.localizer,
        r = t.inclusiveRange,
        o = Fi.range(e, { localizer: n, inclusiveRange: r }),
        a = o[0],
        i = o.slice(1)
    ...
    return (
      ...
      (r.render = function() {
        ...
        var y = this.getView(),
          ...
          M = g.viewNames,
          D = _.toolbar || Gi,
          T = y.title(c, { localizer: O, length: d, inclusiveRange: p })
        return n.createElement(
          'div',
          o({}, u, {
            className: b(l, 'rbc-calendar', m.rtl && 'rbc-is-rtl'),
            style: s,
          }),
          r &&
            n.createElement(D, {
